...
<div id="page-le_cate" class="page">
   ...
   <ul>
      ...
      <li><a href="<?php echo $urlBase; ?>le_cate/david.html">Le roi David: Onction. Goliath.</a></li>
      <li><a href="<?php echo $urlBase; ?>le_cate/davidarche.html">Le roi David: Arche d'alliance. Pardon de Dieu: Urie et Bethsabée. Temple de Salomon.</a><br><span class="txt-vert">Conte du berger: autour de la confiance.</span></li>
      <li><a href="<?php echo $urlBase; ?>le_cate/propheteintro.html">Prophètes introduction : pour les catéchistes.</a></li>
      <li><a href="<?php echo $urlBase; ?>le_cate/prophetes.html">Prophètes généralités.</a></li>
...
<h2>TOUSSAINT, ANNEE LITURGIQUE, AVENT, NOËL, ENFANCE.</h2>
   <ul>
      ...
      <li><a href="<?php echo $urlBase; ?>le_cate/saints.html">La Toussaint: L'étude de quelques saints: St André, St Vincent, Ste thérèse, St Louis-Marie Grignion de Monfort, St Martin, St François.</a>
         <br><span class="txt-rouge">Powerpoint: "Sainte Thérèse".</span>
...
<li><a href="<?php echo $urlBase; ?>le_cate/caremeseptfamilles.html" >Jeu des sept familles. Carême. Année C</a></li>
   ...
   <p class="backtotop"><a href="#top">revenir en haut</a></p>
   <h2>ETRE DISCIPLES. SAINT PIERRE. TEXTES DE SAINT PAUL.</h2>
   <ul>
      ...
      <li><a href="<?php echo $urlBase; ?>le_cate/saintpaul.html">En route avec saint Paul:</a> Travailler quelques épîtres: L'accomplissement de la Loi, c'est l'Amour. S'abaisser jusqu'à mourir. Pour moi, vivre c'est le Christ. Etre préoccupé des autres. Frères, ne soyez inquiets de rien... Je sais vivre de peu...</li>
   </ul>
